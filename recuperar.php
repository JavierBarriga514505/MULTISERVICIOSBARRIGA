      ...
      <div class="row">
        <div class="col-sm-6 text-black">
          ...
          <div class="d-flex align-items-center h-custom-2 px-5 ms-xl-4 mt-5 pt-5 pt-xl-0 mt-xl-n5">
            ...
            <form method="post" action="recuperacion.php" style="width: 23rem;">
              <br>
              <h3 class="fw-normal mb-3 pb-3" align="center" style="letter-spacing: 1px;">Recuperar Cuenta</h3>

              <div class="form-outline mb-4">
                <input type="email" id="email" name="email" class="form-control form-control-lg" />
                <label class="form-label" for="email">Correo Electronico de la cuenta</label>
              </div>

              <div class="pt-1 mb-4">
                <button class="btn btn-info btn-lg btn-block" type="submit">Recuperar cuenta</button>
              </div>
