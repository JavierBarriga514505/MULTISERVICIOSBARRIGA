...
<header class="masthead">
	<div class="container d-flex h-100 align-items-center">
		<div class="mx-auto text-center">
			<h2 class="mx-auto my-0 text-uppercase">Productos Mas Vendidos Segun un Rango de Fechas</h2>
		</div>
	</div><br>
</header>
<div class="container">
	<div class="row">
		...
		<center>
			<label class="col-sm-12 control-label"><span class="glyphicon glyphicon-calendar"></span> Buscar entre fechas</label>
					<form method="POST" action="masvendidosfecha.php">
					<div class="col-sm-12">
...
<input type="datetime-local" id="fecha1"
       ...
       name="fecha2"  required><br><br>
			...
			<div class="panel-body">
						...
						<?php
					echo "<center>";
												$sql1 = "SELECT SUM(cantidad_producto) as suma, referencia_producto FROM detalle_producto WHERE fecha_producto >='" .$fecha1. "' and fecha_producto <='" .$fecha2. "' and movimiento_producto= '3' Group by referencia_producto order by SUM(cantidad_producto)  DESC LIMIT 3";
												$query = mysqli_query($con, $sql1);
												$sql3 = "SELECT COUNT(*) as total FROM detalle_producto WHERE fecha_producto >='" .$fecha1. "'and fecha_producto <= '" .$fecha2. "'  and movimiento_producto= '3' Group by referencia_producto DESC LIMIT 3";
