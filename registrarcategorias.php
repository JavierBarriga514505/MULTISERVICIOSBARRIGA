        ...
        <header class="masthead">
            <div class="container d-flex h-100 align-items-center">
                <div class="mx-auto text-center">
                    <h2 class="mx-auto my-0 text-uppercase">Registrar Categoria</h2>
                </div>
            </div><br>
        </header>
        <div class="container">
                    ...
                    <div class="well well-sm">
                        <form action="guardar_categoria.php" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="mt-2 form-group">
                                <label for="nombreproducto">Nombre de la categoria</label>
                                <input type="text" class="form-control" required name="nombrecategoria" placeholder="Escriba el nombre de su categoria">
                            </div>
