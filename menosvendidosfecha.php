...
<header class="masthead">
	<div class="container d-flex h-100 align-items-center">
		<div class="mx-auto text-center">
			<h2 class="mx-auto my-0 text-uppercase">Productos Menos Vendidos Segun un Rango de Fechas</h2>
		</div>
	</div><br>
</header>
<div class="container">
	<div class="row">
		...
		<center>
			<label class="col-sm-12 control-label"><span class="glyphicon glyphicon-calendar"></span> Buscar entre fechas</label>
					<form method="POST" action="menosvendidosfecha.php">
					<div class="col-sm-12">
			<?php  $fechaactual = date('Y-m-d H:i:s');?>
<b> Fecha a Consultar N°1:</b>
<input type="datetime-local" id="fecha1"
       name="fecha1" required><br>
	   <br>
	   <b> Fecha a Consultar N°2:</b>
	   <input type="datetime-local" id="fecha2"
       name="fecha2"  required><br><br>
			...
			<div class="panel-body">
						...
						<?php
					echo "<center>";
												$sql1 = "SELECT SUM(cantidad_producto) as suma, referencia_producto FROM detalle_producto WHERE fecha_producto >='" .$fecha1. "' and fecha_producto <='" .$fecha2. "' and movimiento_producto= '3' Group by referencia_producto order by SUM(cantidad_producto)  ASC LIMIT 3";
												$query = mysqli_query($con, $sql1);
												$sql3 = "SELECT COUNT(*) as total FROM detalle_producto WHERE fecha_producto >='" .$fecha1. "'and fecha_producto <= '" .$fecha2. "'  and movimiento_producto= '3' Group by referencia_producto ASC LIMIT 3";
												$query3 = mysqli_query($con, $sql3);
												
												$variable= mysqli_num_rows($query3);
												if($variable!=0){
													echo "<br>";
												echo "<h3> PRODUCTO MENOS VENDIDO EN ESTE AÑO ENTRE " . $fecha1." Y " . $fecha2."<h3>";
												echo "<br>";}
													?>
												...
												while ($row1 = mysqli_fetch_array($query)) {
												 ...
												 echo "</tr>";
														...
														if($fecha1>$fecha2){
															echo "<center>";
			echo $mensaje= "<FONT color='red'>Error: la fecha 1 no puede ser mayor a la fecha 2.</font>";
	}else if($variable==0){echo "NO HAY REGISTROS EN ENTRE ESTAS FECHAS "  . $fecha1." AL " . $fecha2;}
echo "</center>";
												echo "</center>"; ?>
