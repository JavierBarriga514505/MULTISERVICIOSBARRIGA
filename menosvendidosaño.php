...
<header class="masthead">
	<div class="container d-flex h-100 align-items-center">
		<div class="mx-auto text-center">
			<h2 class="mx-auto my-0 text-uppercase">Productos menos Vendidos segun su Año</h2>
		</div>
	</div><br>
</header>
<div class="container">
	<div class="row">
		...
		<center>
			<label class="col-sm-12 control-label"><span class="glyphicon glyphicon-calendar"></span> Buscar por Año</label>
					<form method="GET" action="menosvendidosaño.php">
			...
			<div class="panel-body">
				<div class="table-responsive">
					<table class="table">
						...
						<?php
					echo "<center>";
												$sql1 = "SELECT SUM(cantidad_producto) as suma, referencia_producto FROM detalle_producto WHERE YEAR(fecha_producto) = '" .$yearfijo. "' and movimiento_producto= '3' Group by referencia_producto order by SUM(cantidad_producto)  ASC LIMIT 5";
												$query = mysqli_query($con, $sql1);
												$sql3 = "SELECT COUNT(*) as total FROM detalle_producto WHERE YEAR(fecha_producto) = '" .$yearfijo. "' and movimiento_producto= '3' Group by referencia_producto ASC LIMIT 5";
												$query3 = mysqli_query($con, $sql3);
												
												$variable= mysqli_num_rows($query3);
												if($variable!=0){
													echo "<br>";
												echo "<h3> PRODUCTO MENOS VENDIDO EN ESTE AÑO " . $yearfijo."<h3>";
												echo "<br>";}
													?>
													<div class="table-responsive">
