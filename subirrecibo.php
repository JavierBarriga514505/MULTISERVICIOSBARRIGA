      ...
      <div class="well well-sm">
        <div class="mt-2 form-group">
          <div class="single-wid-product">
            <center>
              <label for="image">
                <h2>Subir Foto de Recibo de Pago </h2>
              </label><br>
              <img src="<?php echo $foto_recibo; ?>" title="Descripcion: Recibo de Compra" class="product-thumb img-thumbnail">
              <center>
                <script>console.log("<?= $foto_recibo; ?>");</script>
                <?php if ($foto_recibo == "uploads/noimage.jpeg") { ?>
                  <form action="guardar_imagen1.php" method="POST" enctype="multipart/form-data">
                    <center>
