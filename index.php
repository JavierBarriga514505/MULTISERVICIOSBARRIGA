...
<header class="masthead">
	<div class="container d-flex h-100 align-items-center">
		<div class="mx-auto text-center">
			<h2 class="mx-auto my-0 text-uppercase">Ve nuestra Gran Variedad de Productos</h2>
		</div>
	</div><br>
</header>
<div class="container">
	<div class="row">
		<div class="col-md-12">
			<div class="well well-sm">
				...
				<center>
					<h4><i class='glyphicon glyphicon-search'></i> Busca Tu Producto</h4>
				</center>
			</div>
			<div class="panel-body">
				<form class="form-horizontal" role="form" id="datos_cotizacion">
					<div class="form-group row">
						<label for="q" class="col-md-2 control-label">Escribe el nombre del producto</label>
						<div class="col-md-7">
