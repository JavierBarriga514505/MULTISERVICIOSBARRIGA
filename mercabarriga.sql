...
-- Tiempo de generación: 15-06-2022 a las 18:18:00
...
CREATE TABLE IF NOT EXISTS `ciudades` (
  ...
  KEY `fk_ciudades_departamentos_idx` (`departamentos_IDDEPARTAMENTO`)
...
CREATE TABLE IF NOT EXISTS `compras` (
  ...
  `foto_recibo` varchar(255) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL DEFAULT 'uploads/noimage.jpeg',
...
INSERT INTO `compras` (`id_compra`, `id_usuario`, `total`, `fecha`, `estado`, `foto_recibo`) VALUES
(1, 2, 20000, '2022-06-13 03:08:29', '2', 'uploads/LOGOS ITFIP_1655178859.png'),
(2, 8, 70000, '2022-06-14 19:31:05', '1', 'uploads/Zombatar_1_1655226391.jpg'),
(3, 8, 140000, '2022-06-14 21:27:04', '1', 'uploads/noimage.jpeg'),
(4, 3, 50000, '2022-06-14 18:51:44', '1', 'uploads/noimage.jpeg'),
(5, 3, 50000, '2022-06-14 18:53:41', '1', 'uploads/noimage.jpeg'),
(6, 3, 50000, '2022-06-14 18:55:52', '1', 'uploads/noimage.jpeg'),
(7, 3, 50000, '2022-06-14 18:56:19', '1', 'uploads/noimage.jpeg'),
(8, 3, 50000, '2022-06-14 18:56:45', '1', 'uploads/noimage.jpeg'),
(9, 3, 50000, '2022-06-14 19:01:26', '1', 'uploads/noimage.jpeg'),
(10, 3, 50000, '2022-06-14 19:03:22', '1', 'uploads/noimage.jpeg'),
(11, 3, 50000, '2022-06-14 19:08:13', '1', 'uploads/noimage.jpeg'),
(12, 3, 50000, '2022-06-14 19:09:35', '1', 'uploads/noimage.jpeg'),
(13, 3, 50000, '2022-06-14 19:10:46', '1', 'uploads/noimage.jpeg'),
(14, 3, 50000, '2022-06-14 19:11:24', '1', 'uploads/noimage.jpeg'),
(15, 3, 50000, '2022-06-14 19:12:28', '1', 'uploads/noimage.jpeg'),
(16, 3, 50000, '2022-06-14 19:13:54', '1', 'uploads/noimage.jpeg'),
(17, 3, 20000, '2022-06-14 19:14:19', '1', 'uploads/LOGOS ITFIP_1655216326.png');
...
CREATE TABLE IF NOT EXISTS `detalle_compra` (
  ...
  `precio_individual_producto` int NOT NULL,
...
(1, 1, 1, '12aaa', 20000, 1, 20000),
(2, 2, 2, '12bb', 50000, 1, 50000),
(3, 2, 1, '12aaa', 20000, 1, 20000),
(4, 3, 1, '12aaa', 20000, 2, 40000),
(5, 3, 2, '12bb', 50000, 2, 100000),
(6, 6, 2, '12bb', 50000, 1, 50000),
(7, 7, 2, '12bb', 50000, 1, 50000),
(8, 8, 2, '12bb', 50000, 1, 50000),
(9, 9, 2, '12bb', 50000, 1, 50000),
(10, 10, 2, '12bb', 50000, 1, 50000),
(11, 11, 2, '12bb', 50000, 1, 50000),
(12, 12, 2, '12bb', 50000, 1, 50000),
(13, 13, 2, '12bb', 50000, 1, 50000),
(14, 14, 2, '12bb', 50000, 1, 50000),
(15, 15, 2, '12bb', 50000, 1, 50000),
(16, 16, 2, '12bb', 50000, 1, 50000),
(17, 17, 1, '12aaa', 20000, 1, 20000);
...
CREATE TABLE IF NOT EXISTS `detalle_producto` (
  `id_detalle_producto` bigint NOT NULL AUTO_INCREMENT,
  `id_producto` int NOT NULL,
  `referencia_producto` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_spanish_ci NOT NULL DEFAULT '0',
  ...
  `movimiento_producto` enum('1','2','3') CHARACTER SET utf8mb4 COLLATE utf8mb4_spanish_ci NOT NULL DEFAULT '2' COMMENT '1 ES STOCK EN INVENTARIO,2 ES COMPRA AL PROVEEDOR,3 ES VENTA DEL PRODUCTO',
  PRIMARY KEY (`id_detalle_producto`)
) ENGINE=MyISAM AUTO_INCREMENT=99 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_spanish_ci;
...
INSERT INTO `envios` (`id_envio`, `id_compra`, `name`, `tipo_documento`, `numero_documento`, `celular_usuario`, `email`, `direccion_usuario`, `ciudad_usuario`) VALUES
(4, 5, 'Javier', 'CC', 2, 0, 'javier@gmail.com', 'c', '1'),
(5, 10, 'Javier', 'CC', 2, 0, 'javier@gmail.com', 'c', '3'),
(6, 12, 'Javier', 'CC', 2, 0, 'javier@gmail.com', 'c', '635'),
(7, 17, 'Javier', 'CC', 2, 0, 'javier@gmail.com', 'c', '502');
...
CREATE TABLE IF NOT EXISTS `productos` (
  ...
  `descripcion_producto` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_spanish_ci NOT NULL,
  `id_marca` int NOT NULL,
  `id_categoria` int NOT NULL,
  `fecha_agregado` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `id_usuario` int NOT NULL,
  `estado_producto` tinyint NOT NULL DEFAULT '1',
  `foto_producto` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_spanish_ci NOT NULL DEFAULT 'uploads/noimage.jpeg',
...
CREATE TABLE IF NOT EXISTS `roles_usuarios` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `group_level` (`nivel_rol`)
...
(1, 'Juan', '', 0, 311, 'juan@gmail.com', '8cb2237d0679ca88db6464eac60da96345513964', 'Direccion', 1016, 1, 1, '2022-06-14 09:06:19'),
(2, 'Juan', '', 1, 123, 'juanaristi@gmail.com', '8cb2237d0679ca88db6464eac60da96345513964', 'Carmen', 1025, 3, 1, '2022-06-13 21:45:25'),
...
(8, 'Luz Mila', 'CC', 13451222, 34098767890, 'luzmaria@gmail.com', '8cb2237d0679ca88db6464eac60da96345513964', 'Calle 4 a N 3 20', 1, 3, 1, '2022-06-14 12:17:03'),
