<?php // generacion de la factura por parte del administrador al cliente cuando se hace la compra en punto fisico
session_start();
...
<body>
  ...
  <div id="app" class="col-12">
    <center>
	  ...
	  <a href="detalle_compra2.php?id=<?php echo base64_encode($responseFactura["id_compra"]) ?>&usuario=<?php echo base64_encode($id_usuario) ?>"><button type="button" class="btn btn-primary"><i class="fa fa-plus bigicon"> Generar Factura</i></button></a>
						
      <input type="button" value="Imprimir" class="printbutton"> <a href="verventas.php"><input type="button" value="Volver"></button></a>
      <script>
