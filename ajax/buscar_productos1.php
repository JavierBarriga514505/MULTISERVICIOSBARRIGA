									...
									<div class="single-product-widget">
										<div class="single-wid-product">
											...
											<div class="product-wid-price">
												...
												<center>
													<h5>Precio: $ <?php $precio_publico = $row1['precio_publico'];
													echo  number_format($precio_publico) ?> Cantidad: <?php $cantidadproducto = $row1['cantidad_producto'];
													echo $cantidadproducto ?></h5>
												</center>
												<form action="anadirproductocarrito.php" method="POST">
													<label for="Cantidad_Comprar">Cantidad a Comprar:</label>
													<input type="hidden" id="stock_producto" name="stock_producto" value="<?php echo $cantidadproducto; ?>">
													<input type="hidden" id="precio_producto" name="precio_producto" value="<?php echo $precio_publico; ?>">
													...
													<input type="number" id="cantidad_pedir" name="cantidad_pedir" required min="1" max="<?php echo $cantidadproducto; ?>">
													<center> <input class="btn btn-outline-primary" type="submit" value="Agregar al Carrito">
												</form>
											</div>
										</div>
									</div>
